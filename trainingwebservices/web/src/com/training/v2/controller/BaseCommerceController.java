...
import com.training.exceptions.InvalidPaymentInfoException;
import com.training.exceptions.NoCheckoutCartException;
import com.training.exceptions.UnsupportedDeliveryModeException;
import com.training.populator.options.PaymentInfoOption;
import com.training.validation.data.CartVoucherValidationData;
import com.training.validation.data.CartVoucherValidationDataList;
import com.training.validator.CartVoucherValidator;
import com.training.validator.PlaceOrderCartValidator;
import com.training.validator.PlaceOrderWithoutPayment;
...
import static com.training.constants.YcommercewebservicesConstants.ENUM_VALUES_SEPARATOR;
...
public class BaseCommerceController extends BaseController
{
	...
	@Resource(name = "placeOrderWithoutPayment")
	private PlaceOrderWithoutPayment placeOrderCartValidator;
