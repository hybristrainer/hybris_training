 ...
 */
package com.trainee.test.setup;
...
import com.trainee.test.constants.TraineeTestConstants;
import com.trainee.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TraineeTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/traineetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/traineetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/traineetest/import/cstickets.impex");
			...
			importImpexFile(context, "/traineetest/import/csquotes.impex");
		}
	}
}
