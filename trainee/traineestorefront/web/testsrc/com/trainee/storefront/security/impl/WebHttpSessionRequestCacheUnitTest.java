...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/traineestorefront/electronics/en",
						"https://electronics.local:9002/traineestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/traineestorefront/electronics/en",
						"https://electronics.local:9002/traineestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/traineestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/traineestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/traineestorefront/electronics/en",
						"https://electronics.local:9002/traineestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/traineestorefront",
						"https://electronics.local:9002/traineestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/traineestorefront",
						"https://electronics.local:9002/traineestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/traineestorefront/electronics/en",
						"https://electronics.local:9002/traineestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
