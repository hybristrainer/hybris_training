 ...
 * ----------------------------------------------------------------
 */
package com.trainee.core.constants;
...
public class GeneratedTraineeCoreConstants
{
	public static final String EXTENSIONNAME = "traineecore";
	public static class TC
	{
		public static final String ACCENTURE = "Accenture".intern();
		...
		public static final String TATA = "Tata".intern();
		public static final String TCS = "Tcs".intern();
	}
	public static class Attributes
	{
		public static class Customer
		{
			...
			public static final String PIN = "pin".intern();
		}
		public static class Product
		{
			public static final String PRODUCTSIZE = "productSize".intern();
		}
	}
	...
	protected GeneratedTraineeCoreConstants()
	{
		// private constructor
	}
