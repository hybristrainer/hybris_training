...
/**
 * Global class for all TraineeCore constants. You can add global constants for your extension into this class.
 */
public final class TraineeCoreConstants extends GeneratedTraineeCoreConstants
{
	public static final String EXTENSIONNAME = "traineecore";


	private TraineeCoreConstants()
	{
		//empty
	}
